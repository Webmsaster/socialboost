...
const testimonials = [
  {
    quote:
      "I used to spend 3 hours every Monday writing LinkedIn posts. Now I batch a week of content in 20 minutes and spend the saved time on actual client work.",
    name: "Sarah Chen",
  ...
  {
    quote:
      "The carousel generator alone is worth the subscription. It would take me an hour to design one carousel in Canva — SocialBoost does it in 30 seconds with matching copy.",
    name: "Marcus Rivera",
    role: "Course Creator",
  ...
  {
    quote:
      "As an agency managing 12 clients, we needed a tool that could handle multiple brand voices. SocialBoost lets us save per-client voices and generate consistent content at scale.",
    name: "Lisa Hoffmann",
  ...
  {
    quote:
      "I signed up for the free plan to test it and upgraded to Pro after the first week. The video script generator is a game-changer for TikTok batch shoots.",
    name: "James Okafor",
    role: "Fitness Coach",
    company: "PeakMethod",
  },
  {
    quote:
      "SocialBoost replaced three separate tools we were using for scheduling, AI writing, and content repurposing. One subscription, one workflow, less cognitive overhead.",
    name: "Emily Park",
  ...
  {
    quote:
      "The best part isn't even the AI generation — it's that I actually post consistently now. Showing up every day was my problem, and this solved it.",
    name: "David Mueller",
    role: "Solo Founder",
  ...
  {
    quote:
      "I was skeptical about AI-generated content sounding generic, but the brand voice feature genuinely captures my style. My engagement is up 40% since I started using it.",
    name: "Priya Sharma",
    role: "B2B Consultant",
  ...
  {
    quote:
      "Customer support actually responds within hours, not days. Felt like talking to the founder directly — because I was. That&apos;s rare these days.",
    name: "Tom Becker",
