        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={postType} onValueChange={(v) => setPostType(v as "text" | "video")}>
                <SelectTrigger><SelectValue /></SelectTrigger>
                <SelectContent>
                  <SelectItem value="text">Text post</SelectItem>
                  <SelectItem value="video">Video script (Pro)</SelectItem>
                </SelectContent>
              </Select>
              <p className="text-xs text-muted-foreground">
                {postType === "video"
                  ? "Each run generates a full video script (hook, scenes, CTA). Assets (images, voiceover) are not auto-generated by the cron — open the saved post in Create to produce them."
                  : "Each run generates a platform-native text post."}
              </p>
            </div>
                ...
                <div className="flex items-start justify-between">
                  <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      {series.post_type === "video" && (
                        <Badge className="bg-purple-600 text-white hover:bg-purple-600">Video</Badge>
                      )}
