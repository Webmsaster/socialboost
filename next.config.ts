      ...
      headers: [
        ...
        },
        {
          ...
          value: [
            ...
            `img-src 'self' data: blob: https:${process.env.NODE_ENV !== "production" ? " http://127.0.0.1:* http://localhost:*" : ""}`,
            "font-src 'self' https://fonts.gstatic.com",
            `connect-src 'self' https://*.supabase.co https://api.openai.com https://api.stripe.com https://vitals.vercel-insights.com${process.env.NODE_ENV !== "production" ? " http://127.0.0.1:* http://localhost:*" : ""}`,
            `media-src 'self' data: blob: https:${process.env.NODE_ENV !== "production" ? " http://127.0.0.1:* http://localhost:*" : ""}`,
